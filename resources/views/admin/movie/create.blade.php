                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input name="releaseDate"  id="releaseDate" class="form-control datepicker" placeholder="Vui lòng chọn ngày phát hành" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="endDate">Ngày kết thúc</label>
                                            <input id="endDate" name="endDate" class="form-control datepicker" placeholder="Vui lòng chọn ngày kết thúc" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group file-uploader">
                                            ...
                                            <img style="width: 200px" src="" class="img_movie d-none" alt="user1">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
